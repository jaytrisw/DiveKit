...
extension RateUnit: LocalizationProviding where BaseUnit.Component == LocalizationComponent {
...
private extension RateUnit where BaseUnit.Component == LocalizationComponent {
